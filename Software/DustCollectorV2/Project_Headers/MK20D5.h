...
/** @{ */
#define NUMBER_OF_INT_VECTORS 62 //<! Number of vector table entries
...
#define FMC_TAGVD_valid(x)                       (((uint32_t)(((uint32_t)(x))<<FMC_TAGVD_valid_SHIFT))&FMC_TAGVD_valid_MASK) /**< FMC_TAGVD.valid Field                   */
#define FMC_TAGVD_tag_MASK                       (0x7FFC0U)                                          /**< FMC_TAGVD.tag Mask                      */
#define FMC_TAGVD_tag_SHIFT                      (6U)                                                /**< FMC_TAGVD.tag Position                  */
#define FMC_TAGVD_tag(x)                         (((uint32_t)(((uint32_t)(x))<<FMC_TAGVD_tag_SHIFT))&FMC_TAGVD_tag_MASK) /**< FMC_TAGVD.tag Field                     */
/** @} */

/** @name S - Cache Data Storage */ /** @{ */
#define FMC_DATAW_data_MASK                      (0xFFFFFFFFU)                                       /**< FMC_DATAW.data Mask                     */
#define FMC_DATAW_data_SHIFT                     (0U)                                                /**< FMC_DATAW.data Position                 */
#define FMC_DATAW_data(x)                        (((uint32_t)(((uint32_t)(x))<<FMC_DATAW_data_SHIFT))&FMC_DATAW_data_MASK) /**< FMC_DATAW.data Field                    */
/** @} */
...
/* ================================================================================ */
/* ================           LLWU (file:LLWU_ME_PE4_FILT2_RST_MK20D5)       ================ */
/* ================================================================================ */
