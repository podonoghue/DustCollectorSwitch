 ...
 * @version   1.3.0
 * @brief     Peripheral declarations for MK20DN64VLF5
 *
 * *****************************
...
public:
   ...
   PORTB->GPCHR = 0x0100UL|PORT_GPCHR_GPWE(0x0001UL);
   }
   ...
   PORTB->GPCHR = PinMux_Disabled|PORT_GPCHR_GPWE(0x0001UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: GPIOC_1              = PTC1(p34)                      */  { PortCInfo,  1,            (PcrValue)0x00100UL  },
         /*   2: GPIOC_2              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   3: GPIOC_3              = PTC3(p36)                      */  { PortCInfo,  3,            (PcrValue)0x00100UL  },
   ...
   PORTC->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x004AUL);
   }
   ...
   PORTC->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x004AUL);
   }
...
public:
   ...
   PORTD->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0080UL);
   }
   ...
   PORTD->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0080UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   4: ADC0_SE4b            = PTC2(p35)                      */  { PortCInfo,  2,            (PcrValue)0x00000UL  },
         /*   5: ADC0_SE5b            = PTD1(p42)                      */  { PortDInfo,  1,            (PcrValue)0x00000UL  },
         ...
         /*  13: ADC0_SE13            = PTB3(p30)                      */  { PortBInfo,  3,            (PcrValue)0x00000UL  },
         /*  14: ADC0_SE14            = PTC0(p33)                      */  { PortCInfo,  0,            (PcrValue)0x00000UL  },
   ...
   PORTC->GPCLR = 0x0000UL|PORT_GPCLR_GPWE(0x0005UL);
   ...
   PORTB->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0008UL);
   PORTC->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0005UL);
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: CMP1_IN0             = PTC2(p35)                      */  { PortCInfo,  2,            (PcrValue)0x00000UL  },
   ...
   PORTC->GPCLR = 0x0000UL|PORT_GPCLR_GPWE(0x0004UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: JTAG_TCLK            = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   2: SWD_CLK              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         ...
         /*   6: JTAG_TMS             = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*   7: SWD_DIO              = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   6: LLWU_P6              = PTC1(p34)                      */  { PortCInfo,  1,            (PcrValue)0x00100UL  },
         /*   7: LLWU_P7              = PTC3(p36)                      */  { PortCInfo,  3,            (PcrValue)0x00100UL  },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   8: TSI0_CH8             = PTB3(p30)                      */  { PortBInfo,  3,            (PcrValue)0x00000UL  },
         ...
         /*  13: TSI0_CH13            = PTC0(p33)                      */  { PortCInfo,  0,            (PcrValue)0x00000UL  },
         /*  14: TSI0_CH14            = --                             */  { NoPortInfo, UNMAPPED_PCR, (PcrValue)0          },
         /*  15: TSI0_CH15            = PTC2(p35)                      */  { PortCInfo,  2,            (PcrValue)0x00000UL  },
   };
...
///  -------------- | ------------------------------|--------------------------------------------------- | ------------------------- | ----------------------------------------------------
///  ADC0_DM0       | CurrentSample                 | ADC0_DM0                                           | p8                        | -
///  ADC0_DP0       | CurrentSample                 | ADC0_DP0                                           | p7                        | -
///  PIT_CH0        | PollingTimerChannel           | PIT_CH0                                            | Internal                  | Timer channel for polling
///  PTB3           | HoldControl                   | ADC0_SE13                                          | p30                       | Analogue input level controlling hold time
///  PTB16          | HoldLed                       | GPIOB_16                                           | p31                       | LED indicating in hold state
///  PTC0           | DelayControl                  | ADC0_SE14                                          | p33                       | Analogue input level controlling delay time
///  PTC1           | DelayLed                      | GPIOC_1                                            | p34                       | LED indicating in delay state
///  PTC2           | LevelControl                  | ADC0_SE4b                                          | p35                       | Analogue input level controlling detection level
///  PTC3           | DetectLed                     | GPIOC_3                                            | p36                       | LED indicating load detection
///  PTC6           | DustCollector                 | GPIOC_6                                            | p39                       | Control for dust collector
///  PTD1           |                               | ADC0_SE5b                                          | p42                       | Analogue input measuring instantaneous load current
///  PTD7           | Debug                         | GPIOD_7                                            | p48                       | General Debug pin
///
///
