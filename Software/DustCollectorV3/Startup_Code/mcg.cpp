...
const ClockInfo Mcg::clockInfo[] = {
   {  // ClockConfig_RUN_FEI_48MHz (McgClockMode_FEI)
   
      /// SIM CLKDIV1 System Clock Divider Register 1 
      SIM_CLKDIV1_OUTDIV4(15) | // Flash Clock Divider (OUTDIV4) - Divide by [1-16] - /16
      SIM_CLKDIV1_OUTDIV2(15) | // Bus Clock Divider (OUTDIV2) - Divide by [1-16] - /16
      SIM_CLKDIV1_OUTDIV1(15),  // Core & System Clock Divider (OUTDIV1) - Divide by [1-16] - /16

      Sim::DefaultSopt2Values[ClockConfig_RUN_FEI_48MHz].sopt2,

      /// Clock Mode 
      McgClockMode_FEI,  // Default Clock Mode - FLL Engaged Internal (FEI)
      ...
      McgRange0_Low | // Frequency Range Select - Low range
      ...
      McgFllLockRange_Mid,  // DCO Range Select - Mid (x1280/x1464, 40-50/48 MHz)
      ...
      MCG_C5_PRDIV0(0),  // PLL0 External Reference Divider

      /// Control Register 6 
      PllLossOfClockInterrupt_Disabled | // PLL Loss of Lock Interrupt Enable - No interrupt request
      McgPllFllSelect_FLL | // FLL/PLL Clock selection for MCGOUTCLK when CLKS=0 - FLL is selected
