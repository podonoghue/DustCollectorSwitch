...
Startup_Code/%.o: ../Startup_Code/%.cpp Startup_Code/subdir.mk
	...
	arm-none-eabi-g++ -mcpu=cortex-m0plus -mthumb -fcallgraph-info=su -O3 -ffunction-sections -fdata-sections -fno-rtti -Wall -Wextra -DRELEASE_BUILD -DNDEBUG -I"../Sources" -I"../Project_Headers" -fno-exceptions -std=c++17 -c -fmessage-length=0 -MT"$@" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@"  -o "$@" $<
