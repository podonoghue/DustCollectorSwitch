...
Startup_Code/%.o: ../Startup_Code/%.cpp Startup_Code/subdir.mk
	...
	arm-none-eabi-g++ -mcpu=cortex-m0plus -mthumb -fcallgraph-info=su -O3 -ffunction-sections -fdata-sections -fno-rtti -Wall -Wextra -DRELEASE_BUILD -DNDEBUG -I"../Sources" -I"../Project_Headers" -fno-exceptions -std=c++20 -c -fmessage-length=0 -MT"$@" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@"  -o "$@" $<
...
Startup_Code/%.o: ../Startup_Code/%.c Startup_Code/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: ARM C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -fcallgraph-info=su -O3 -ffunction-sections -fdata-sections -Wall -Wextra -DRELEASE_BUILD -DNDEBUG -I"../Sources" -I"../Project_Headers" -std=c17 -c -fmessage-length=0 -MT"$@" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@"  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
...
Startup_Code/%.o: ../Startup_Code/%.S Startup_Code/subdir.mk
	...
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -fcallgraph-info=su -O3 -ffunction-sections -fdata-sections -Wall -Wextra -x assembler-with-cpp -DRELEASE_BUILD -DNDEBUG -I"../Project_Headers" -Wall -Wextra -c -fmessage-length=0  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
