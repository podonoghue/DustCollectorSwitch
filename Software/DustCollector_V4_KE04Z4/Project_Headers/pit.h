 ...
 */
   ...
   enum PitChannelNum : uint8_t {
      ...
      PitChannelNum_PollingTimerChannel   = 0,           ///< Channel 0
...
public:
   ...
   static inline CallbackFunction sCallbacks[2] = {
      PitInfo::unhandledCallback,  // PIT_Ch0_IRQn 
      PitInfo::unhandledCallback,  // PIT_Ch1_IRQn 
   };
   ...
   static constexpr ChannelInit DefaultChannelInitValues[] = {
      ...
      4799_ticks,                  // (pit_ldval_tsv[0])         Reload value channel 0
      NvicPriority_Normal ,        // (irqLevel_Ch0)             IRQ priority level for Ch0 - Normal
      unhandledCallback,           // (handlerName_Ch0)          User declared event handler
      },
      {
      PitChannelNum_1,

      PitChannelEnable_Enabled ,   // (pit_tctrl_ten[1])         Timer Channel Enable - Channel enabled
      PitChannelChain_Disabled ,   // (pit_tctrl_chn[1])         Chain with previous channel - Timers are not chained
      PitChannelAction_None ,      // (pit_tctrl_tie[1])         Action on timer event - None
      0_ticks,                     // (pit_ldval_tsv[1])         Reload value channel 1
      NvicPriority_Normal ,        // (irqLevel_Ch1)             IRQ priority level for Ch1 - Normal
      unhandledCallback,           // (handlerName_Ch1)          User declared event handler
      },
