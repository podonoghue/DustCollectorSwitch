/**
 * @file     pit.h (180.ARM_Peripherals/Project_Headers/pit-MKE.h)
 *
...
public:
    ...
    *
    * @code
    * class PitCallbackClass {
    * public:
    *    int y;
    *
    *    // Member function used as callback
    *    // This function must match Pit::CallbackFunction
    *    void callback() {
    *       ...;
    *    }
    * };
    ...
    * static PitCallbackClass PitCallbackClassInstance;
    * ...
    * // Wrap member function
    * auto Pitcbfn = Pit::wrapCallback<PitCallbackClass, &PitCallbackClass::callback, PitCallbackClassInstance>();
    *
    * // Use as callback
    * Pit::Channel<0>::setCallback(Pitcbfn);
    * @endcode
    */
    ...
    * ...
    * // Instance of class containing callback member function
    * PitCallbackClass PitCallbackClassInstance;
    * ...
    * // Wrap member function
    * auto Pitcbfn = Pit::wrapCallback<PitCallbackClass, &PitCallbackClass::callback>(PitCallbackClassInstance);
    *
