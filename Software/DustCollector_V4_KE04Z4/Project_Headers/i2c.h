 ...
 */
    ...
    */
   enum I2cBusStopDetectFlag : uint8_t {
      I2cBusStopDetectFlag_NoStopDetected   = I2C_FLT_STOPF(0),  ///< No stop happens on I2C bus
      I2cBusStopDetectFlag_StopDetected     = I2C_FLT_STOPF(1),  ///< Stop detected on I2C bus
   };
    ...
    */
   enum I2cStartStopInterrupt : uint8_t {
   ...
   /**
    * Bus Start Detect Flag
    * (i2c_flt_startf)
    *
    * Hardware sets this bit when the I2C bus start status is detected.
    * The STARTF bit must be cleared by writing 1 to it
    */
   enum I2cBusStartDetectFlag : uint8_t {
      I2cBusStartDetectFlag_NoStartHappensOnI2cBus   = I2C_FLT_STARTF(0),  ///< No start happens on I2C bus
      I2cBusStartDetectFlag_StartDetectedOnI2cBus    = I2C_FLT_STARTF(1),  ///< Start detected on I2C bus
   };
