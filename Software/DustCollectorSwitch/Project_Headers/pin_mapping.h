 ...
 * @version   1.3.0
 * @brief     Peripheral declarations for FRDM_K20D50M
 *
 * *****************************
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: GPIOA_1              = PTA1(D5)                       */  { PortAInfo,  1,            (PcrValue)0x00100UL  },
   ...
   PORTA->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0002UL);
   }
   ...
   PORTA->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0002UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   8: GPIOC_8              = PTC8(D4)                       */  { PortCInfo,  8,            (PcrValue)0x00100UL  },
   ...
   PORTC->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0100UL);
   }
   ...
   PORTC->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0100UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   1: GPIOD_1              = PTD1(D13)                      */  { PortDInfo,  1,            (PcrValue)0x00100UL  },
   ...
   PORTD->GPCLR = 0x0100UL|PORT_GPCLR_GPWE(0x0002UL);
   }
   ...
   PORTD->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0002UL);
   }
...
public:
   ...
   static constexpr uint32_t osc_clock = 
      8000000;  // Frequency of OSC Clock or Crystal [OSCCLK]
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: XTAL0                = PTA19(XTAL0)                   */  { PortAInfo,  19,           (PcrValue)0x00000UL  },
         /*   1: EXTAL0               = PTA18(EXTAL0)                  */  { PortAInfo,  18,           (PcrValue)0x00000UL  },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: XTAL32               = XTAL32(XTAL32)                 */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   1: EXTAL32              = EXTAL32(EXTAL32)               */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: ADC0_SE0             = ADC0_DP0(A10)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   1: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*   3: ADC0_SE3             = ADC0_DP3(A8)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         ...
         /*   7: ADC0_SE7b            = PTD6(A2)                       */  { PortDInfo,  6,            (PcrValue)0x00000UL  },
         ...
         /*  14: ADC0_SE14            = PTC0(A0)                       */  { PortCInfo,  0,            (PcrValue)0x00000UL  },
         /*  15: ADC0_SE15            = PTC1(A1)                       */  { PortCInfo,  1,            (PcrValue)0x00000UL  },
         /*  16: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*  17: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*  18: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*  19: ADC0_SE19            = ADC0_DM0(A11)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  20: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*  21: ADC0_SE21            = ADC0_DM3(A9)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  22: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*  23: ADC0_SE23            = ADC0_SE23(A7)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
   ...
   PORTC->GPCLR = 0x0000UL|PORT_GPCLR_GPWE(0x0003UL);
   ...
   PORTC->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0003UL);
   PORTD->GPCLR = PinMux_Disabled|PORT_GPCLR_GPWE(0x0040UL);
   }
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
            /*   0: ADC0_DP0             = ADC0_DP0(A10)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
            /*   1: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   3: ADC0_DP3             = ADC0_DP3(A8)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
      };
   ...
   public:
      ...
      static constexpr PinInfo  info[] = {
            ...
            //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
            /*   0: ADC0_DM0             = ADC0_DM0(A11)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
            /*   1: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
            /*   3: ADC0_DM3             = ADC0_DM3(A9)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
      };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   4: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*   5: CMP0_IN5             = VREF_OUT(A6)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*   2: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*   3: CMP1_IN3             = ADC0_SE23(A7)                  */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   4: --                   = --                             */  { NoPortInfo, INVALID_PCR,  (PcrValue)0          },
         /*   5: CMP1_IN5             = VREF_OUT(A6)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
...
using SWD_DIO_pin          = PcrTable_T<ControlInfo,7>;
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: RESET_b              = RESET_b(RESET_b)               */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   1: JTAG_TCLK            = PTA0(SWD_CLK)                  */  { PortAInfo,  0,            (PcrValue)0x00700UL  },
         /*   2: SWD_CLK              = PTA0(SWD_CLK)                  */  { PortAInfo,  0,            (PcrValue)0x00700UL  },
         ...
         /*   6: JTAG_TMS             = PTA3(SWD_DIO)                  */  { PortAInfo,  3,            (PcrValue)0x00700UL  },
         /*   7: SWD_DIO              = PTA3(SWD_DIO)                  */  { PortAInfo,  3,            (PcrValue)0x00700UL  },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: VBAT                 = VBAT(VBAT)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   1: VDD1                 = VDD1(VDD1)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   2: VDD2                 = VDD2(VDD2)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   3: VDD3                 = VDD3(VDD3)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   4: VDDA                 = VDDA(VDDA)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   5: VOUT33               = VOUT33(VOUT33)                 */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   6: VREFH                = VREFH(VREFH)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   7: VREFL                = VREFL(VREFL)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   8: VREGIN               = VREGIN(VREGIN)                 */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   9: VSS1                 = VSS1(VSS1)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  10: VSS2                 = VSS2(VSS2)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  11: VSS3                 = VSS3(VSS3)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*  12: VSSA                 = VSSA(VSSA)                     */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
   };
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         /*  13: TSI0_CH13            = PTC0(A0)                       */  { PortCInfo,  0,            (PcrValue)0x00000UL  },
         /*  14: TSI0_CH14            = PTC1(A1)                       */  { PortCInfo,  1,            (PcrValue)0x00000UL  },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: UART0_TX             = PTB17(ConTx)                   */  { PortBInfo,  17,           (PcrValue)0x00300UL  },
         /*   1: UART0_RX             = PTB16(ConRx)                   */  { PortBInfo,  16,           (PcrValue)0x00300UL  },
   ...
   PORTB->GPCHR = PinMux_Disabled|PORT_GPCHR_GPWE(0x0003UL);
   }
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: USB0_DM              = USB0_DM(USB0_DM)               */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
         /*   1: USB0_DP              = USB0_DP(USB0_DP)               */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
...
public:
   ...
   static constexpr PinInfo  info[] = {
         ...
         //      Signal                 Pin                                  portInfo    gpioBit                 PCR value
         /*   0: VREF_OUT             = VREF_OUT(A6)                   */  { NoPortInfo, FIXED_NO_PCR, (PcrValue)0          },
   };
