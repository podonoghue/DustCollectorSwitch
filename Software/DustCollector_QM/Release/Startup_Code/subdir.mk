...
Startup_Code/%.o: ../Startup_Code/%.c Startup_Code/subdir.mk
	@echo 'Building file: $<'
	@echo 'Invoking: ARM C Compiler'
	arm-none-eabi-gcc -mcpu=cortex-m0plus -mthumb -fcallgraph-info=su -O3 -ffunction-sections -fdata-sections -Wall -Wextra -DRELEASE_BUILD -DNDEBUG -I"../Sources" -I"../Project_Headers" -I"/opt/qp/qpc/ports/arm-cm/qv/gnu" -I"/opt/qp/qpc/include" -std=c17 -c -fmessage-length=0 -MT"$@" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@"  -o "$@" $<
	@echo 'Finished building: $<'
	@echo ' '
